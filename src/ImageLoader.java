...
public class ImageLoader {
	...
	private static final List<String> extensions = Arrays.asList("", ".jpg",
			".png", ".gif", ".JPG", ".PNG", ".GIF");
	 ...
	 *
	 * @param fileName
	 *            Navnet på bildefilen, inkludert katalognavn
	 * @return Et bilde
	 */
	public static ImageIcon getImage(String fileName) {
		...
		for (String imagePath : imagePaths) {
			for (String extension : extensions) {
				URL url = Main101Games.class.getResource(imagePath + fileName
						+ extension);
				if (url != null) {
